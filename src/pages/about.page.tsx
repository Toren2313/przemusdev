...
function AboutPage() {
  ...
  return (
    <div className={Helper.SECTION_MAIN_STYLE}>
      <GradientHighlight position={HighlightPosition.top_right} />
          ...
          <div className={gradientBoxStyle}>
            <div className={`${boxStyle} flex flex-col text-center items-stretch p-3 gap-5`}>
              ...
              <p className="text-sm text-justify font-dm_sans text-white p-4 bg-text_icons_bg rounded-md">
                ...
                JavaScript/TypeScript. Proficient in building REST APIs using Express and Nest.js frameworks.
                Experienced in deploying production-ready code and managing both relational databases (MySQL,
                PostgreSQL) and NoSQL solutions (MongoDB). Additionally, skilled in developing simple desktop
                applications using C# and creating console applications with C++
              </p>
      ...
      <GradientHighlight position={HighlightPosition.center_left} />
    </div>
  );
}
